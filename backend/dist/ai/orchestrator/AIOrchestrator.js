...
class AIOrchestrator {
     ...
     */
    buildInsightPromptVariables(insightType, context, metadata) {
        return {
     ...
     */
    async buildInsightContext(insightType, organizationId, workspaceId) {
     ...
     */
    generateInsightTitle(insightType, context) {
        switch (insightType) {
