...
export class AlertEngine {
  ...
  private constructor() {
    ...
    this.evaluator = new AlertEvaluator(this.supabase);
    this.dispatcher = new NotificationDispatcher(this.supabase);
  }
   ...
   */
  async updateRule(id: string, updates: Partial<Omit<AlertRule, 'id' | 'createdAt'>>): Promise<AlertRule> {
  ...
  startPeriodicEvaluation(): void {
    ...
    }, this.EVALUATION_INTERVAL_MS) as unknown as number;
  }
